    ...
    <div className={styles.container}>
      ...
      >
        ...
        <div className={styles.links}>
          <a className={styles.link} href="/">All Posts</a>
          <a className={styles.link} href="/">My Posts</a>
        </div>
      </div>
		<label className={styles.switchLabel}>
      <input className={styles.switchInput}
        type="checkbox"
        onChange={(event) => {
          ...
          if (event.target.checked) {
            ...
            style.setProperty("--secondary-text-color", " rgb(127, 127, 138)");
